class CommandsController < ApplicationController
  ...
  private
    ...
    def command_params
      params.require(:command).permit(:numclient, :refproduit, :article, :descriptif, :numcommande, :quantitearticle, :totalprixarticle, :totalprixcommande, :date, :produit_id, :validation)
    end
end
